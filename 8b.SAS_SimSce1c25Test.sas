***********************************************************************************************************************************************************************************;
*Program: 8b.SAS_SimSce1c25Test                                                                                                                                                    ;
*Purpose: Import test simulated data sets under Scenario 1 (baBIC method) with 25% censoring from R and obtain some general statistics                                             ;                                     
...
*libname savedata 'E:\Grisell\AlexSei\R01eprognosisOutcomes\sasdata'; /*to run the program in the Reap server*/
...
%impdata(inputdata=sim10testbaBICc25_20210109_, rep=50, outputdata=outtest.sim500testbaBICc25);
...
*QC;
proc sort data=simdata2 out=test; by sim; data test; set test; by sim; if first.sim; run; /*500 simulations*/
proc delete data=test; run; quit;
...
title;
ods rtf file='path\Results_StatsSimtestbaBICc25VsOriginal.rtf' startpage=no;
ods text= "Simulated datasets (S=&SIM and 25% censoring)";
...
ods startpage=now;
ods text= "Simulated datasets (S=&SIM and 25% censoring) ADL";
...
ods startpage=now;
ods text= "Simulated datasets (S=&SIM and 25% censoring) IADL";
...
ods startpage=now;
ods text= "Simulated datasets (S=&SIM and 25% censoring) WALK";
...
ods startpage=now;
ods text= "Simulated datasets (S=&SIM and 25% censoring) DEATH";
