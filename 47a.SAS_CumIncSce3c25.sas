***********************************************************************************************************************************************************************************;
*Program: 47a.SAS_CumIncSce3c25                                                                                                                                                    ;                                                               
*Purpose: Compute Cumulative Incidence for simulations of Scenario 3 with 25% censoring and training data                                                                          ;                                     
...
%let traindata=outtrain.sim500trainFullc25;
...
data outdata.CumIncsce3c25_adl; set CumIncPred_adl; run;
data outdata.CumIncsce3c25_iadl; set CumIncPred_iadl; run;
data outdata.CumIncsce3c25_walk; set CumIncPred_walk; run;
data outdata.CumIncsce3c25_death; set CumIncPred_death; run;
*Stack all 4 datasets;
data outdata.CumIncsce3c25_all; set CumIncPred_adl CumIncPred_iadl CumIncPred_walk CumIncPred_death; run;

PROC EXPORT DATA=outdata.CumIncsce3c25_adl
            OUTFILE= "path\CumIncsce3c25_adl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncsce3c25_iadl
            OUTFILE= "path\CumIncsce3c25_iadl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncsce3c25_walk
            OUTFILE= "path\CumIncsce3c25_walk.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncsce3c25_death
            OUTFILE= "path\CumIncsce3c25_death.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncsce3c25_all
            OUTFILE= "path\CumIncsce3c25_all.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
