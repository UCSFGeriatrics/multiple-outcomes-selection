********************************************************************************************************************************************************************************************;
*Program: 6a.SAS_SimSce1CorrTrain                                                                                                                                                           ;                                                               
*Purpose: Generate simulated training datasets with correlated outcomes and predictors from baBIC model of HRS case-study data. Compute some statistics (Scenario 1, correlated outcomes)   ;                                     
...
proc contents data=savedata.sim500corrTrain; run;
...
%let SIM=500; /*number of simulations*/
title;
ods rtf file='path\Results_Statssim500corrTrainVsOriginal.rtf' startpage=no;
...
proc print data=savedata.pearsonsim500corrTrain (firstobs=1 obs=10); run;
proc print data=savedata.pearsonsim500corrTrain (firstobs=491 obs=502); run;

ods startpage=now;
ods text= "Simulated datasets (S=&SIM) Spearman Correlation";
proc print data=savedata.spearmansim500corrTrain (firstobs=1 obs=10); run;
proc print data=savedata.spearmansim500corrTrain (firstobs=491 obs=502); run;
