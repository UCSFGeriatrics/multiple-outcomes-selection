***********************************************************************************************************************************************************************************;
*Program: 43a.SAS_CumIncSce2Corr                                                                                                                                                   ;                                                               
*Purpose: Compute Cumulative Incidence for Scenario 2 simulated training correlated data                                                                                           ;                                     
...
proc sort data=savedata.sim500corrByTrain out=simdata; by newid; run;/*11062000 observations and 5 variables.*/
...
data outdata.CumIncbaBICcorrby_adl; set CumIncPred_adl; run;
data outdata.CumIncbaBICcorrby_iadl; set CumIncPred_iadl; run;
data outdata.CumIncbaBICcorrby_walk; set CumIncPred_walk; run;
data outdata.CumIncbaBICcorrby_death; set CumIncPred_death; run;
*Stack all 4 datasets;
data outdata.CumIncbaBICcorrby_all; set CumIncPred_adl CumIncPred_iadl CumIncPred_walk CumIncPred_death; run;

PROC EXPORT DATA=outdata.CumIncbaBICcorrby_adl
            OUTFILE= "path\CumIncbaBICcorrby_adl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncbaBICcorrby_iadl
            OUTFILE= "path\CumIncbaBICcorrby_iadl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncbaBICcorrby_walk
            OUTFILE= "path\CumIncbaBICcorrby_walk.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncbaBICcorrby_death
            OUTFILE= "path\CumIncbaBICcorrby_death.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncbaBICcorrby_all
            OUTFILE= "path\CumIncbaBICcorrby_all.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
