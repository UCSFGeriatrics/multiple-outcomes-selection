***************************************************************************************************************************************************************************************;
*Program: 22.SAS_BICbackwardIndOutcomeSimSce3c25                                                                                                                                       ;                                                               
*Purpose: BIC backward elimination for individual outcomes for simulations of Scenario 3 with 25% censoring and training data. Obtain Union and Intersection model for each simulation ;                                     
...
data bicsimind_Sce3c25  (drop=delims i x: n i temp);
 set BICsim ;
...
proc means data=bicsimind_Sce3c25 stackodsoutput n mean stderr clm median p25 p75 maxdec=4; 
 ...
 ods output summary=bicsimind_Sce3c25_stats(rename=(Mean=Mean_sim_Ind));
proc sort; by variable; run;

PROC EXPORT DATA= bicsimind_Sce3c25_stats
