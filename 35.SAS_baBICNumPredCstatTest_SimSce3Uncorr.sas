***********************************************************************************************************************************************************************************;
*Program: 35.SAS_baBICNumPredCstatTest_SimSce3uncorr                                                                                                                               ;                                                               
*Purpose: Compute summary statistics for Number of predictors and C-statistic for baBIC method in Scenario 3 simulated testing uncorrelated data                                   ;                                     
...
%let trainmod=outdata.baBICsim500uncorrSce3;
...
/*
======MONITORING: 2020-10-13, 11:13======
======MONITORING: 2020-10-13, 11:24======
*/

proc sort data=ctablesim out=outdata.sim&S.baBICtestfulluncorr_c; by sim; run;

PROC EXPORT DATA=outdata.sim&S.baBICtestfulluncorr_c
            OUTFILE= "path\sim500testing\Full\baBICModeltesting\baBICtestfulluncorr_c.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

*Summary stats of baBIC training simulated models on baBIC testing simulated data;
proc means data=outdata.sim&S.baBICtestfulluncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_adl C_iadl C_walk C_death C_avg;
 ods output summary=outdata.sim&S.baBICtestfulluncorr_cmeans(rename=(Mean=Mean_Sim_baBICtesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim&S.baBICtestfulluncorr_cmeans
            OUTFILE= "path\sim&S.baBICtestfulluncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


proc delete data=ctablesim trainmod simdata3; run; quit;
