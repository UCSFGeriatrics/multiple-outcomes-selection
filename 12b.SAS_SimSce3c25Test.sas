***********************************************************************************************************************************************************************************;
*Program: 12b.SAS_SimSce3c25Test                                                                                                                                                   ;
*Purpose: Import test simulated data sets under Scenario 3 (Full method) with 25% censoring from R and obtain some general statistics                                              ;                                     
...
%impdata(inputdata=sim10testFullc25_20210109_, rep=50, outputdata=outtest.sim500testFullc25); 
...
title;
ods rtf file='path\Results_StatsSimtestFullc25VsOriginal.rtf' startpage=no;
