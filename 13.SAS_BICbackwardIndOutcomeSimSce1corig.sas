*************************************************************************************************************************************************************************************************;
*Program: 13.SAS_BICbackwardIndOutcomeSimSce1corig                                                                                                                                               ;                                                               
*Purpose: BIC backward elimination for individual outcomes for simulations of Scenario 1 with case-study censoring and training data. Obtain Union and Intersection model for each simulation    ;                                     
...
data bicsimind_sce1corig  (drop=delims i x: n i temp);
 set BICsim ;
...
proc means data=bicsimind_sce1corig stackodsoutput n mean stderr clm median p25 p75 maxdec=4; 
 ...
 ods output summary=bicsimind_sce1corig_stats(rename=(Mean=Mean_sim_Ind));
proc sort; by variable; run;

PROC EXPORT DATA= bicsimind_sce1corig_stats
