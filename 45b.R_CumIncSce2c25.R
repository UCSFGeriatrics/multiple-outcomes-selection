############### Cumulative Incidence Plot: Scenario 2(Individual outcome) 25% censoring   #########################
...
########################### color version ##################################
png("CumIncSce2c25.png",width = 1800, height = 1500, res = 600)
ggplot() +
