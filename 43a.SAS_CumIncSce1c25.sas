***********************************************************************************************************************************************************************************;
*Program: 43a.SAS_CumIncSce1c25                                                                                                                                                    ;                                                               
*Purpose: Compute Cumulative Incidence for simulations of Scenario 1 with 25% censoring and training data                                                                          ;                                     
...
%let traindata=outtrain.sim500trainbabicc25;
...
data outdata.CumIncSce1c25_adl; set CumIncPred_adl; run;
data outdata.CumIncSce1c25_iadl; set CumIncPred_iadl; run;
data outdata.CumIncSce1c25_walk; set CumIncPred_walk; run;
data outdata.CumIncSce1c25_death; set CumIncPred_death; run;
*Stack all 4 datasets;
data outdata.CumIncSce1c25_all; set CumIncPred_adl CumIncPred_iadl CumIncPred_walk CumIncPred_death; run;

PROC EXPORT DATA=outdata.CumIncSce1c25_adl
            OUTFILE= "path\CumIncSce1c25_adl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncSce1c25_iadl
            OUTFILE= "path\CumIncSce1c25_iadl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncSce1c25_walk
            OUTFILE= "path\CumIncSce1c25_walk.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncSce1c25_death
            OUTFILE= "path\CumIncSce1c25_death.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncSce1c25_all
            OUTFILE= "path\CumIncSce1c25_all.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
