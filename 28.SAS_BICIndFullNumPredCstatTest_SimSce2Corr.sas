***********************************************************************************************************************************************************************************;
*Program: 28.SAS_BICIndFullNumPredCstatTest_SimSce2Corr                                                                                                                            ;                                                               
*Purpose: Compute summary statistics for Number of predictors and C-statistic for Individual, Union, Intersect, and Full methods in Scenario 2 simulated testing correlated data   ;                                     
...
%let trainmod_ind=outdata.bicsim500corrby;
%let testdata=savedata.sim500corrByTest;
