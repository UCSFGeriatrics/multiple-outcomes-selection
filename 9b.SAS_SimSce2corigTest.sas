***********************************************************************************************************************************************************************************;
*Program: 9b.SAS_SimSce2corigTest                                                                                                                                                  ;
*Purpose: Import test simulated data sets under Scenario 2 (Individual method) with case-study censoring from R and obtain some general statistics                                 ;                                     
...
%impdata(inputdata=sim10testIndcorig_20210109_, rep=50, outputdata=outtest.sim500testIndcorig);  
...
title;
ods rtf file='path\Results_StatsSimtestIndcorigVsOriginal.rtf' startpage=no;
