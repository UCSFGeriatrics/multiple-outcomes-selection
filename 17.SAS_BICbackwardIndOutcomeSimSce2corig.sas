*************************************************************************************************************************************************************************************************;
*Program: 17.SAS_BICbackwardIndOutcomeSimSce2corig                                                                                                                                               ;                                                               
*Purpose: BIC backward elimination for individual outcomes for simulations of Scenario 2 with case-study censoring and training data. Obtain Union and Intersection model for each simulation    ;                                     
...
data bicsimind_Sce2corig  (drop=delims i x: n i temp);
 set BICsim ;
...
proc means data=bicsimind_Sce2corig stackodsoutput n mean stderr clm median p25 p75 maxdec=4; 
 ...
 ods output summary=bicsimind_Sce2corig_stats(rename=(Mean=Mean_sim_Ind));
proc sort; by variable; run;

PROC EXPORT DATA= bicsimind_Sce2corig_stats
