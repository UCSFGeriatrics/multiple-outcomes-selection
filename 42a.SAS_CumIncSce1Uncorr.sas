***********************************************************************************************************************************************************************************;
*Program: 42a.SAS_CumIncSce1Uncorr                                                                                                                                                 ;                                                               
*Purpose: Compute Cumulative Incidence for Scenario 1 simulated training uncorrelated data                                                                                         ;                                     
...
proc sort data=savedata.sim500uncorrTrain out=simdata; by newid; run;/*11062000 observations and 5 variables.*/
...
data outdata.CumIncbaBICuncorr_adl; set CumIncPred_adl; run;
data outdata.CumIncbaBICuncorr_iadl; set CumIncPred_iadl; run;
data outdata.CumIncbaBICuncorr_walk; set CumIncPred_walk; run;
data outdata.CumIncbaBICuncorr_death; set CumIncPred_death; run;
*Stack all 4 datasets;
data outdata.CumIncbaBICuncorr_all; set CumIncPred_adl CumIncPred_iadl CumIncPred_walk CumIncPred_death; run;

PROC EXPORT DATA=outdata.CumIncbaBICuncorr_adl
            OUTFILE= "path\CumIncbaBICuncorr_adl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncbaBICuncorr_iadl
            OUTFILE= "path\CumIncbaBICuncorr_iadl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncbaBICuncorr_walk
            OUTFILE= "path\CumIncbaBICuncorr_walk.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncbaBICuncorr_death
            OUTFILE= "path\CumIncbaBICuncorr_death.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncbaBICuncorr_all
            OUTFILE= "path\CumIncbaBICuncorr_all.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
