***********************************************************************************************************************************************************************************;
*Program: 7a.SAS_SimSce1corigTrain                                                                                                                                                 ;
*Purpose: Import training simulated data sets under Scenario 1 (baBIC method) with case-study censoring from R and obtain some general statistics                                  ;                                     
...
%impdata(inputdata=sim10trainbaBICcorig_20210109_, rep=50, outputdata=outtrain.sim500trainbaBICcorig);
...
data simdata2; 
  merge savedata.originaldata (drop=time_adldepdth status_adldepdth time_iadldifdth status_iadldifdth time_walkdepdth status_walkdepdth time2death death) 
        outtrain.sim500trainbaBICcorig;
  by newid;
run;
...
title;
ods rtf file='path\Results_StatsSimTrainbaBICcorigVsOriginal.rtf' startpage=no;
