***********************************************************************************************************************************************************************************;
*Program: 29.SAS_BICIndFullNumPredCstatTest_SimSce2uncorr                                                                                                                          ;                                                               
*Purpose: Compute summary statistics for Number of predictors and C-statistic for Individual, Union, Intersect, and Full methods in Scenario 2 simulated testing uncorrelated data ;                                     
...
%let trainmod_ind=outdata.bicsim500uncorrby;
%let testdata=savedata.sim500uncorrByTest;
...
/*
=====MONITORING: 2020-09-21, 16:50======
======MONITORING: 2020-09-21, 17:02======
======MONITORING: 2020-09-21, 17:17======
======MONITORING: 2020-09-21, 17:27======
======MONITORING: 2020-09-21, 17:45======
*/

*Save permanent datasets;
data outdata.sim500indtestbyuncorr_c; set sim500indtest_c; run;
data outdata.sim500uniontestbyuncorr_c; set sim500uniontest_c; run;
data outdata.sim500inttestbyuncorr_c; set sim500intersecttest_c; run;
data outdata.sim500fulltestbyuncorr_c; set sim500fulltest_c; run;

*Summary stats of individual training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500indtestbyuncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500indtestbyuncorr_cmeans(rename=(Mean=Mean_Sim_indtesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500indtestbyuncorr_cmeans
            OUTFILE= "path\sim500indtestbyuncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

*Summary stats of union training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500uniontestbyuncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_avg C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500uniontestbyuncorr_cmeans(rename=(Mean=Mean_Sim_uniontesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500uniontestbyuncorr_cmeans
            OUTFILE= "path\sim500uniontestbyuncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

*Summary stats of intersect training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500inttestbyuncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_avg C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500inttestbyuncorr_cmeans(rename=(Mean=Mean_Sim_inttesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500inttestbyuncorr_cmeans
            OUTFILE= "path\sim500inttestbyuncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

*Summary stats of full training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500fulltestbyuncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_avg C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500fulltestbyuncorr_cmeans(rename=(Mean=Mean_Sim_fulltesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500fulltestbyuncorr_cmeans
            OUTFILE= "path\sim500fulltestbyuncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
