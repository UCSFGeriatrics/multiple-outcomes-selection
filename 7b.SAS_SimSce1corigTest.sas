***********************************************************************************************************************************************************************************;
*Program: 7b.SAS_SimSce1corigTest                                                                                                                                                  ;
*Purpose: Import test simulated data sets under Scenario 1 (baBIC method) with case-study censoring from R and obtain some general statistics                                      ;                                     
...
%impdata(inputdata=sim10testbaBICcorig_20210109_, rep=50, outputdata=outtest.sim500testbaBICcorig);
...
title;
ods rtf file='path\Results_StatsSimtestbaBICcorigVsOriginal.rtf' startpage=no;
