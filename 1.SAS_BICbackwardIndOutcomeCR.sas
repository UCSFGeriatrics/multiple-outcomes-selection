...
*Purpose: BIC backward elimination by Outcome using HRS original dataset. It uses Cox regression for Death, and Competing-risk regression for rest of outcomes                     ;                                     
...
data savedata.BIC_BestModelsUnion (drop=delims i variable allvars);
 set BIC;
 length allvars $1000;
