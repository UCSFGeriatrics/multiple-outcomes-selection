***********************************************************************************************************************************************************************************;
*Program: 10a.SAS_SimSce2c25Train                                                                                                                                                  ;
*Purpose: Import training simulated datasets under Scenario 2 (Individual method) with 25% censoring from R and obtain some gral statistics                                        ;                                     
...
%impdata(inputdata=sim10trainIndc25_20210109_, rep=50, outputdata=outtrain.sim500trainIndc25); 
...
title;
ods rtf file='\path\Results_StatsSimTrainIndc25VsOriginal.rtf' startpage=no;
