***********************************************************************************************************************************************************************************;
*Program: 45a.SAS_CumIncSce3Corr                                                                                                                                                   ;                                                               
*Purpose: Compute Cumulative Incidence for Scenario 3 simulated training correlated data                                                                                           ;                                     
...
proc sort data=savedata.sim500corrFullTrain  out=simdata; by newid; run;/*11062000 observations and 5 variables.*/
...
data outdata.CumIncbaBICcorrfull_adl; set CumIncPred_adl; run;
data outdata.CumIncbaBICcorrfull_iadl; set CumIncPred_iadl; run;
data outdata.CumIncbaBICcorrfull_walk; set CumIncPred_walk; run;
data outdata.CumIncbaBICcorrfull_death; set CumIncPred_death; run;
*Stack all 4 datasets;
data outdata.CumIncbaBICcorrfull_all; set CumIncPred_adl CumIncPred_iadl CumIncPred_walk CumIncPred_death; run;

PROC EXPORT DATA=outdata.CumIncbaBICcorrfull_adl
            OUTFILE= "path\CumIncbaBICcorrfull_adl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncbaBICcorrfull_iadl
            OUTFILE= "path\CumIncbaBICcorrfull_iadl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncbaBICcorrfull_walk
            OUTFILE= "path\CumIncbaBICcorrfull_walk.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncbaBICcorrfull_death
            OUTFILE= "path\CumIncbaBICcorrfull_death.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncbaBICcorrfull_all
            OUTFILE= "path\CumIncbaBICcorrfull_all.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
