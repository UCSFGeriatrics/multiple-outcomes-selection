***********************************************************************************************************************************************************************************;
*Program: 33.SAS_BICIndFullNumPredCstatTest_SimSce3Uncorr                                                                                                                          ;                                                               
*Purpose: Compute summary statistics for Number of predictors and C-statistic for Individual, Union, Intersect, and Full methods in Scenario 3 simulated testing uncorrelated data ;                                     
...
%let trainmod_ind=outdata.bicnewsim500uncorrFull;
%let testdata=savedata.sim500uncorrFullTest;
...
/*
======MONITORING: 2020-09-21, 18:07======
======MONITORING: 2020-09-21, 18:20======
======MONITORING: 2020-09-21, 18:35======
======MONITORING: 2020-09-21, 18:46======
======MONITORING: 2020-09-21, 19:04======
*/

*Save permanent datasets;
data outdata.sim500indtestfulluncorr_c; set sim500indtest_c; run;
data outdata.sim500uniontestfulluncorr_c; set sim500uniontest_c; run;
data outdata.sim500intttestfulluncorr_c; set sim500intersecttest_c; run;
data outdata.sim500fulltestfulluncorr_c; set sim500fulltest_c; run;

*Summary stats of individual training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500indtestfulluncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500indtestfulluncorr_cmeans(rename=(Mean=Mean_Sim_indtesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500indtestfulluncorr_cmeans
            OUTFILE= "path\sim500indtestfulluncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

*Summary stats of union training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500uniontestfulluncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_avg C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500uniontestfulluncorr_cmeans(rename=(Mean=Mean_Sim_uniontesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500uniontestfulluncorr_cmeans
            OUTFILE= "path\sim500uniontestfulluncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

*Summary stats of intersect training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500intttestfulluncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_avg C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500inttestfulluncorr_cmeans(rename=(Mean=Mean_Sim_inttesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500inttestfulluncorr_cmeans
            OUTFILE= "path\sim500inttestfulluncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

*Summary stats of full training simulated models on baBIC testing simulated data;
proc means data=outdata.sim500fulltestfulluncorr_c stackodsoutput n mean clm stderr maxdec=4; 
 var C_avg C_adl C_iadl C_walk C_death;
 ods output summary=outdata.sim500fulltestfulluncorr_cmeans(rename=(Mean=Mean_Sim_fulltesting));
proc sort; by variable; run;

PROC EXPORT DATA= outdata.sim500fulltestfulluncorr_cmeans
            OUTFILE= "path\sim500fulltestfulluncorr_cmeans.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
