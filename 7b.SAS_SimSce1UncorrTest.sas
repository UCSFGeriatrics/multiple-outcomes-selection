********************************************************************************************************************************************************************************************;
*Program: 7b.SAS_SimSce1UncorrTest                                                                                                                                                          ;                                                               
*Purpose: Generate simulated testing datasets with uncorrelated outcomes and predictors from baBIC model of HRS case-study data. Compute some statistics (Scenario 1, uncorrelated outcomes);                                    
...
data savedata.sim500uncorrTest;
...
proc sort data=savedata.sim500uncorrTest out=simdata; by newid; run; 
...
%let SIM=500; /*number of simulations*/
title;
ods rtf file="path\Results_Statssim500uncorrTestVsOriginal.rtf" startpage=no;
...
proc print data=savedata.pearsonsim500uncorrTest (firstobs=1 obs=10); run; 
proc print data=savedata.pearsonsim500uncorrTest (firstobs=491 obs=502); run;

ods startpage=now;
ods text= "Simulated datasets (S=&SIM) Spearman Correlation";
proc print data=savedata.spearmansim500uncorrTest (firstobs=1 obs=10); run;
proc print data=savedata.spearmansim500uncorrTest (firstobs=491 obs=502); run;
