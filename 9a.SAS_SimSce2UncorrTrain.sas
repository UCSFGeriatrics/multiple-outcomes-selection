********************************************************************************************************************************************************************************************************;
*Program: 9a.SAS_SimSce2UncorrTrain                                                                                                                                                                     ;                                                               
*Purpose: Generate simulated training datasets with uncorrelated outcomes and predictors from Best Individual models of HRS case-study data. Compute some statistics (Scenario 2, uncorrelated outcomes);                                  
...
data savedata.sim500uncorrByTrain;
...
%let SIM=500; /*number of simulations*/
title;
ods rtf file="path\Results_Statssim500uncorrByTrainVsOriginal.rtf" startpage=no;
...
proc print data=savedata.pearsonsim500uncorrByTrain (firstobs=1 obs=10); run;
proc print data=savedata.pearsonsim500uncorrByTrain (firstobs=491 obs=502); run;

ods startpage=now;
ods text= "Simulated datasets (S=&SIM) Spearman Correlation";
proc print data=savedata.spearmansim500uncorrByTrain (firstobs=1 obs=10); run;
proc print data=savedata.spearmansim500uncorrByTrain (firstobs=491 obs=502); run;
