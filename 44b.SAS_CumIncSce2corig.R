############### Cumulative Incidence Plot: Scenario 2(Individual Outcome) case-study censoring   #########################
...
########################### color version ##################################
png("CumIncSce2corig.png",width = 1800, height = 1500, res = 600)
ggplot() +
