***********************************************************************************************************************************************************************************;
*Program: 44a.SAS_CumIncSce2corig                                                                                                                                                  ;                                                               
*Purpose: Compute Cumulative Incidence for simulations of Scenario 2 with case-study censoring and training data                                                                   ;                                     
...
%let traindata=outtrain.sim500trainindcorig;
...
proc sort data=&traindata  out=simdata; by newid; run;/*11062000 observations and 5 variables.*/
...
%let VARNAME_adl=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU DIABETES  EXERCISE OTHERARM OTHERLIFT OTHERSTOOP ;
%let VARNAME_iadl=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU OTHERSIT cogdl1 cogdl2 smoke1 smoke2 HEARAID ;
%let VARNAME_walk=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE OTHERSIT HYPERTENSION climb1 climb2 ;
%let VARNAME_death=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE DIABETES EXERCISE cogdl1 cogdl2 smoke1 smoke2 HYPERTENSION climb1 climb2 HEARTFAILURE
...
data covdata_means_adl;
 set outdata.covdata_means (keep=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU DIABETES  EXERCISE OTHERARM OTHERLIFT OTHERSTOOP);
run;

data covdata_means_iadl;
 set outdata.covdata_means (keep=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU OTHERSIT cogdl1 cogdl2 smoke1 smoke2 HEARAID);
run;

data covdata_means_walk;
 set outdata.covdata_means (keep=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE OTHERSIT HYPERTENSION climb1 climb2);
run;

data covdata_means_death;
 set outdata.covdata_means (keep=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE DIABETES EXERCISE cogdl1 cogdl2 smoke1 smoke2 HYPERTENSION climb1 climb2 HEARTFAILURE
                              lun1 lun2 MSTAT  OTHERPUSH walk1 walk2 bmi1 bmi2 bmi3 bmi4 VOLUNTEER);
run;
...
data outdata.CumIncSce2corig_adl; set CumIncPred_adl; run;
data outdata.CumIncSce2corig_iadl; set CumIncPred_iadl; run;
data outdata.CumIncSce2corig_walk; set CumIncPred_walk; run;
data outdata.CumIncSce2corig_death; set CumIncPred_death; run;
*Stack all 4 datasets;
data outdata.CumIncSce2corig_all; set CumIncPred_adl CumIncPred_iadl CumIncPred_walk CumIncPred_death; run;

PROC EXPORT DATA=outdata.CumIncSce2corig_adl
            OUTFILE= "path\CumIncSce2corig_adl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncSce2corig_iadl
            OUTFILE= "path\CumIncSce2corig_iadl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncSce2corig_walk
            OUTFILE= "path\CumIncSce2corig_walk.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncSce2corig_death
            OUTFILE= "path\CumIncSce2corig_death.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncSce2corig_all
            OUTFILE= "path\CumIncSce2corig_all.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
