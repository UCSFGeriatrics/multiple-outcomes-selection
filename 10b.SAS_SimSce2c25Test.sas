***********************************************************************************************************************************************************************************;
*Program: 10b.SAS_SimSce2c25Test                                                                                                                                                   ;
*Purpose: Import test simulated data sets under Scenario 2 (Individual method) with 25% censoring from R and obtain some general statistics                                        ;                                     
...
%impdata(inputdata=sim10testIndc25_20210109_, rep=50, outputdata=outtest.sim500testIndc25); 
...
title;
ods rtf file='path\Results_StatsSimtestIndc25VsOriginal.rtf' startpage=no;
