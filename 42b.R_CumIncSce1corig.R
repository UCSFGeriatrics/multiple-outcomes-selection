############### Cumulative Incidence Plot: Scenario 1(baBIC) case-study censoring   #########################
...
########################### color version ##################################
png("CumIncSce1corig.png",width = 1800, height = 1500, res = 600)
ggplot() +
