***********************************************************************************************************************************************************************************;
*Program: 12a.SAS_SimSce3c25Train                                                                                                                                                  ;
*Purpose: Import training simulated datasets under Scenario 3 (Full method) with 25% censoring from R and obtain some gral statistics                                              ;                                     
...
%impdata(inputdata=sim10trainFullc25_20210109_, rep=50, outputdata=outtrain.sim500trainFullc25); 
...
title;
ods rtf file='\path\Results_StatsSimTrainFullc25VsOriginal.rtf' startpage=no;
