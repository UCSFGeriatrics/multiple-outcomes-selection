********************************************************************************************************************************************************************************************;
*Program: 11a.SAS_SimSce3UncorrTrain                                                                                                                                                        ;                                                               
*Purpose: Generate simulated training datasets with uncorrelated outcomes and predictors from Full model of HRS case-study data. Compute some statistics (Scenario 3, uncorrelated outcomes);                                     
...
data savedata.sim500uncorrFullTrain;
...
%let SIM=500; /*number of simulations*/
title;
ods rtf file="path\Results_Statssim500uncorrFullTrainVsOriginal.rtf" startpage=no;
...
proc print data=savedata.pearsonsim500uncorrFullTrain (firstobs=1 obs=10); run; 
proc print data=savedata.pearsonsim500uncorrFullTrain (firstobs=491 obs=502); run;

ods startpage=now;
ods text= "Simulated datasets (S=&SIM) Spearman Correlation";
proc print data=savedata.spearmansim500uncorrFullTrain (firstobs=1 obs=10); run;
proc print data=savedata.spearmansim500uncorrFullTrain (firstobs=491 obs=502); run;
