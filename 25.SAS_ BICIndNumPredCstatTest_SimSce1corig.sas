...
proc stdize data=outtest.c_indsce1corig PctlMtd=ORD_STAT outstat=outtest.c_indsce1corig_percentiles pctlpts=2.5, 97.5;
 var C_adl C_iadl C_walk C_death ;
run;
/*Specify the PCTLMTD= option so that the algorithm uses the traditional "sort the data" algorithm for computing percentiles,
rather than a newer one-pass algorithm. Although the one-pass algorithm is very fast and well-suited for computing the median, 
...
data outtest.c_indsce1corig_percentiles;
 set outtest.c_indsce1corig_percentiles;
 where _type_ =: 'P';
...
proc print data=outtest.c_indsce1corig_percentiles noobs; run;
...
proc stdize data=outtest.c_unionsce1corig PctlMtd=ORD_STAT outstat=outtest.c_unionsce1corig_percentiles pctlpts=2.5, 97.5;
 var C_adl C_iadl C_walk C_death ;
run;
/*Specify the PCTLMTD= option so that the algorithm uses the traditional "sort the data" algorithm for computing percentiles,
rather than a newer one-pass algorithm. Although the one-pass algorithm is very fast and well-suited for computing the median, 
...
data outtest.c_unionsce1corig_percentiles;
 set outtest.c_unionsce1corig_percentiles;
 where _type_ =: 'P';
 C_adl=round(C_adl,0.01);
 C_iadl=round(C_iadl,0.01);
 C_walk=round(C_walk,0.01);
...
proc print data=outtest.c_unionsce1corig_percentiles noobs; run;
...
proc stdize data=outtest.c_interssce1corig PctlMtd=ORD_STAT outstat=outtest.c_interssce1corig_percentiles pctlpts=2.5, 97.5;
 var C_adl C_iadl C_walk C_death ;
run;
/*Specify the PCTLMTD= option so that the algorithm uses the traditional "sort the data" algorithm for computing percentiles,
rather than a newer one-pass algorithm. Although the one-pass algorithm is very fast and well-suited for computing the median, 
...
data outtest.c_interssce1corig_percentiles;
 set outtest.c_interssce1corig_percentiles;
 where _type_ =: 'P';
 C_adl=round(C_adl,0.01);
 C_iadl=round(C_iadl,0.01);
 C_walk=round(C_walk,0.01);
...
proc print data=outtest.c_interssce1corig_percentiles noobs; run;
...
proc stdize data=outtest.c_fullsce1corig PctlMtd=ORD_STAT outstat=outtest.c_fullsce1corig_percentiles pctlpts=2.5, 97.5;
 var C_adl C_iadl C_walk C_death ;
run;
/*Specify the PCTLMTD= option so that the algorithm uses the traditional "sort the data" algorithm for computing percentiles,
rather than a newer one-pass algorithm. Although the one-pass algorithm is very fast and well-suited for computing the median, 
...
data outtest.c_fullsce1corig_percentiles;
 set outtest.c_fullsce1corig_percentiles;
 where _type_ =: 'P';
 C_adl=round(C_adl,0.01);
 C_iadl=round(C_iadl,0.01);
 C_walk=round(C_walk,0.01);
...
proc print data=outtest.c_fullsce1corig_percentiles noobs; run;
