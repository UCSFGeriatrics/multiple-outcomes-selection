****************************************************************************************************************************************************************************************;
*Program: 10a.SAS_SimSce3corrTrain                                                                                                                                                      ;                                                               
*Purpose: Generate simulated training datasets with correlated outcomes and predictors from Full model of HRS case-study data. Compute some statistics (Scenario 3, correlated outcomes);               ;                                     
...
data savedata.sim500corrFullTrain;
...
proc contents data=savedata.sim500corrFullTrain; run;
...
%let SIM=500; /*number of simulations*/
title;
ods rtf file='path\Results_Statssim500corrFullTrainVsOriginal.rtf' startpage=no;
...
proc print data=savedata.pearsonsim500corrFullTrain (firstobs=1 obs=10); run;
proc print data=savedata.pearsonsim500corrFullTrain (firstobs=491 obs=502); run;

ods startpage=now;
ods text= "Simulated datasets (S=&SIM) Spearman Correlation";
proc print data=savedata.spearmansim500corrFullTrain (firstobs=1 obs=10); run;
proc print data=savedata.spearmansim500corrFullTrain (firstobs=491 obs=502); run;
