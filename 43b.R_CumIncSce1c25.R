############### Cumulative Incidence Plot: Scenario 1(baBIC) 25% censoring   #########################
...
########################### color version ##################################
png("CumIncSce1c25.png",width = 1800, height = 1500, res = 600)
ggplot() +
