***************************************************************************************************************************************************************************************************;
*Program: 8b.SAS_SimSce2CorrTest                                                                                                                                                                   ;                                                               
*Purpose: Generate simulated testing datasets with correlated outcomes and predictors from Best Individual models of HRS case-study data. Compute some statistics (Scenario 2, correlated outcomes);                                     
...
data savedata.sim500corrByTest;
...
proc sort data=savedata.sim500corrByTest out=simdata; by newid; run; 
...
%let SIM=500; /*number of simulations*/
title;
ods rtf file="path\Results_Statssim500corrByTestVsOriginal.rtf" startpage=no;
...
proc print data=savedata.pearsonsim500corrByTest (firstobs=1 obs=10); run;
proc print data=savedata.pearsonsim500corrByTest (firstobs=491 obs=502); run;

ods startpage=now;
ods text= "Simulated datasets (S=&SIM) Spearman Correlation";
proc print data=savedata.spearmansim500corrByTest (firstobs=1 obs=10); run;
proc print data=savedata.spearmansim500corrByTest (firstobs=491 obs=502); run;
