***********************************************************************************************************************************************************************************;
*Program: 42a.SAS_CumIncSce1corig                                                                                                                                                  ;                                                               
*Purpose: Compute Cumulative Incidence for simulations of Scenario 1 with case-study censoring and training data                                                                   ;                                     
...
%let traindata=outtrain.sim500trainbabiccorig;
...
proc means data=finaldata2 n min max mean; var age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU DIABETES EXERCISE OTHERSIT cogdl1 cogdl2 smoke1 smoke2
                             HYPERTENSION climb1 climb2 OTHERARM OTHERLIFT  OTHERSTOOP HEARAID HEARTFAILURE lun1 lun2 MSTAT
                             OTHERPUSH walk1 walk2 bmi1 bmi2 bmi3 bmi4 VOLUNTEER alcoh1 alcoh2 ARTHRITIS canc1 canc2 cogim1 cogim2 EYE2G
                             fal1 fal2 hear1 hear2 hear3 hear4 LALONE OTHERCHAIR OTHERDIME PAIN CESDALL  father1 father2 father3 mother1 mother2 mother3
                             health1 health2 health3 health4 strok1 strok2; run;

proc means data=finaldata2 stackodsoutput mean maxdec=4; 
...
%let newvars=%sysfunc(compbl(age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU DIABETES EXERCISE OTHERSIT cogdl1 cogdl2 smoke1 smoke2
                             HYPERTENSION climb1 climb2 OTHERARM OTHERLIFT  OTHERSTOOP HEARAID HEARTFAILURE lun1 lun2 MSTAT
                             OTHERPUSH walk1 walk2 bmi1 bmi2 bmi3 bmi4 VOLUNTEER alcoh1 alcoh2 ARTHRITIS canc1 canc2 cogim1 cogim2 EYE2G
                             fal1 fal2 hear1 hear2 hear3 hear4 LALONE OTHERCHAIR OTHERDIME PAIN CESDALL  father1 father2 father3 mother1 mother2 mother3
                             health1 health2 health3 health4 strok1 strok2));
...
***************************************************** Compute Cumulative Incidence for each simulated data using the baBIC model from case-study data ******************************************************************;
...
%let VARNAME=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU DIABETES EXERCISE cogdl1 cogdl2 smoke1 smoke2 climb1 climb2
...
data covdata_means;
 set outdata.covdata_means (keep=age1 age2 age3 age4 age5 age6 age7 age8 age9 SEX DRIVE INCONTINENCE EDU DIABETES EXERCISE cogdl1 cogdl2 smoke1 smoke2 climb1 climb2
                              HEARTFAILURE lun1 lun2 OTHERPUSH bmi1 bmi2 bmi3 bmi4 VOLUNTEER);
run;
...
data outdata.CumIncSce1corig_adl; set CumIncPred_adl; run;
data outdata.CumIncSce1corig_iadl; set CumIncPred_iadl; run;
data outdata.CumIncSce1corig_walk; set CumIncPred_walk; run;
data outdata.CumIncSce1corig_death; set CumIncPred_death; run;
*Stack all 4 datasets;
data outdata.CumIncSce1corig_all; set CumIncPred_adl CumIncPred_iadl CumIncPred_walk CumIncPred_death; run;

PROC EXPORT DATA=outdata.CumIncSce1corig_adl
            OUTFILE= "path\CumIncSce1corig_adl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncSce1corig_iadl
            OUTFILE= "path\CumIncSce1corig_iadl.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;

PROC EXPORT DATA=outdata.CumIncSce1corig_walk
            OUTFILE= "path\CumIncSce1corig_walk.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncSce1corig_death
            OUTFILE= "path\CumIncSce1corig_death.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;


PROC EXPORT DATA=outdata.CumIncSce1corig_all
            OUTFILE= "path\CumIncSce1corig_all.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
