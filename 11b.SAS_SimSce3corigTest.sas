***********************************************************************************************************************************************************************************;
*Program: 11b.SAS_SimSce3corigTest                                                                                                                                                 ;
*Purpose: Import test simulated data sets under Scenario 3 (Full method) with case-study censoring from R and obtain some general statistics                                       ;                                     
...
%impdata(inputdata=sim10testFullcorig_20210109_, rep=50, outputdata=outtest.sim500testFullcorig);  
...
title;
ods rtf file='path\Results_StatsSimtestFullcorigVsOriginal.rtf' startpage=no;
